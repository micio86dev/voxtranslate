...
const PATHS: Record<string, string> = {
  ...
  // Single person — profile (spec: friends/profile).
  user:
    '<path d="M20 21v-2a4 4 0 0 0-4-4H8a4 4 0 0 0-4 4v2"/><circle cx="12" cy="7" r="4"/>',
  // Room-info disclosure (spec 0061 / #98): the ⓘ button in the on-video meta cluster.
  info:
  ...
  // Account menu (billing) — Lucide "wallet".
  wallet:
    '<path d="M21 12V7H5a2 2 0 0 1 0-4h14v4"/><path d="M3 5v14a2 2 0 0 0 2 2h16v-5"/><path d="M18 12a2 2 0 0 0 0 4h4v-4Z"/>',
  // Account menu (notifications) — Lucide "bell".
  bell:
  ...
  // Lucide "bug" — the report-a-problem affordance (spec 0071).
  bug:
  ...
  board:
    '<rect x="3" y="4" width="18" height="13" rx="2"/><path d="M12 17v4"/><path d="M8 21h8"/>',
  eraser:
    '<path d="m7 21-4.3-4.3a1 1 0 0 1 0-1.4l9.6-9.6a1 1 0 0 1 1.4 0l4.6 4.6a1 1 0 0 1 0 1.4L13 21"/><path d="M22 21H7"/><path d="m5 11 9 9"/>',
  game:
  ...
  // Overflow "More" menu (spec 0023) — three filled dots.
  more:
  ...
  // Pan / move (spec 0033) — 4-way arrows for the screen-share pan/zoom toggle.
  move:
  ...
  // Already a friend — person + check (in-call tile friend badge).
  'user-check':
