...
pub fn build_pdf_doc(
    ...
    serde_json::json!({
        ...
        // AI Act Art. 50(2): this export leaves the session and is stored/shared, so it
        // does not qualify for the real-time ephemeral carve-out the live call relies on.
        // `ai_notice` is the human-readable label; `ai_keywords` lands in the PDF metadata
        // (see transcript.typ) so the marking is machine-readable too.
        "ai_notice": "Transcribed and translated by AI — may contain errors.",
        "ai_keywords": ["AI-generated", "AI-translated"],
        "footer": format!(
            "Generated by VoxTranslate · AI-generated content · {}",
